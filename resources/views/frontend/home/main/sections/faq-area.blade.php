          ...
          <div class="col-lg-6">
              <div class="faq__content">
                  <div class="section__title pb-10">
                      ...
                      <h2 class="title">{{ __('Start Learning From World\'s Pro Instructors') }}</h2>
                  </div>
                  <p>{{ __('Groove\'s intuitive shared inbox makes it easy for team members to organize, prioritize and.In this episode.') }}</p>
                  <div class="faq__wrap">
