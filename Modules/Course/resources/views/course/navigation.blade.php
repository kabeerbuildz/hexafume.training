        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link navigation-btn {{ request('step') == 4 ? 'active' : '' }}" id="itemFour-tab"
                    data-step="4">{{ __('Course Fees') }}</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link navigation-btn {{ request('step') == 5 ? 'active' : '' }}" id="itemFive-tab"
                    data-step="5">{{ __('Analytics') }}</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="nav-link navigation-btn {{ request('step') == 6 ? 'active' : '' }}" id="itemSix-tab"
                    data-step="6">{{ __('Finish') }}</button>
            </li>
        </ul>
    </div>
</div>
