...
use App\Http\Controllers\Admin\FeeStructureLocationController;
use App\Http\Controllers\Admin\FeeStructureDurationController;
use App\Http\Controllers\Admin\CourseFeeStructureController;
use App\Http\Controllers\Admin\FeeStructureBranchController;
...
Route::group(['as' => 'admin.', 'prefix' => 'admin'], function () {
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::resource('fee-structure-locations', FeeStructureLocationController::class)->names('fee-structure-locations');
        Route::resource('fee-structure-durations', FeeStructureDurationController::class)->names('fee-structure-durations');
        Route::resource('course-fee-structures', CourseFeeStructureController::class)->names('course-fee-structures');
        Route::resource('fee-structure-branches', FeeStructureBranchController::class)->names('fee-structure-branches');
    });
