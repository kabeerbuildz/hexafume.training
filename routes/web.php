...
use App\Http\Controllers\Frontend\PartnersPageController;
...
Route::group(['middleware' => 'maintenance.mode'], function () {
    ...
    Route::get('all-programs', [HomePageController::class, 'allPrograms'])->name('all-programs');
    Route::get('training-schedule', [HomePageController::class, 'trainingSchedule'])->name('training-schedule');
    Route::get('fee-structure', [HomePageController::class, 'feeStructure'])->name('fee-structure');
    ...
    Route::get('our-partners', [PartnersPageController::class, 'index'])->name('our-partners');
    /** Contact page routes */
    Route::get('contact', [ContactController::class, 'index'])->name('contact.index');
    Route::post('contact/send-mail', [ContactController::class, 'sendMail'])->name('contact.send-mail');
    
    /** Enrollment routes */
    Route::get('enrollment/courses', [HomePageController::class, 'getEnrollmentCourses'])->name('enrollment.courses');
    Route::post('enrollment/submit', [HomePageController::class, 'submitEnrollment'])->name('enrollment.submit');

    /** Fee Structure API */
    Route::get('fee-structure/data', [HomePageController::class, 'getFeeStructureData'])->name('fee-structure.data');
    Route::get('fee-structure/download', [HomePageController::class, 'downloadFeeStructure'])->name('fee-structure.download');
